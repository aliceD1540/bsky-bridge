...
5. マスターキーを生成してCloudflare Secretsに設定
...
6. `wrangler deploy` でデプロイ

7. ブラウザでWorkerのURLにアクセスし、アカウント登録と設定を実施
...
Threads APIを使用するためにはMeta for Developersでアプリを作成し、アクセストークンを取得する必要があります：
